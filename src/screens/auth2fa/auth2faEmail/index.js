...
const auth2faEmail = ({ navigation, navigation: { goBack } }) => {
        ...
        <View centerH>
          <BoxBlue textBlue01 containerStyle={{ height: verticalScale(520) }}>
            <View flex-1 centerV centerH padding-30>
              <Text h13 regular textGray>{i18n.t('Auth2fa.textEmailAuthentication')}</Text>
              <DivSpace height-20 />
              <View centerH>
                <ImageComponent
                  source={IconSms}
                ...
                />
                <DivSpace height-40 />
                <Text h10 textGray regular>{i18n.t('Auth2fa.textUseASecurityCodeSentTo')}</Text>
                <DivSpace height-20 />
              </View>
              <View flex-1 bottom centerH>
                <ButtonRounded
                  ...
                  size='lg'
                >
                  <Text h10 semibold textBlue01 center>
