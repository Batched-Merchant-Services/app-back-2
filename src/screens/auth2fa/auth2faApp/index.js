...
const auth2faApp = ({ navigation, navigation: { goBack } }) => {
    ...
    <SignUpWrapper >
      <SafeAreaView forceInset={{ top: 'always' }}>
        <NavigationBar
          ...
          body={i18n.t('Auth2fa.textAuthenticationVia') + i18n.t('Auth2fa.textExternal')}
        />
        <DivSpace height-15 />
        <View centerH>
          <BoxBlue textBlue01 containerStyle={{ height: verticalScale(520) }}>
            <View flex-1 centerV centerH padding-30>
              <Text h13 regular textGray>{i18n.t('Auth2fa.textTwoFactorAuthentication')}</Text>
              <DivSpace height-20 />
              <View centerH>
                <ImageComponent
                  source={IconSms}
