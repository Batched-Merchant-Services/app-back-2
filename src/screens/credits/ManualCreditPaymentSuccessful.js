      ...
      <View marginH-18 textBlueDark style={Styles.manualCreditWrapper}>
        <View centerH>
          ...
          <Text h16 medium center white>
            {i18n.t('manualCreditPayment.component.partial')}
          </Text>
          <DivSpace height-20 />
          <BoxGradient size={82}>
            <ImageComponent
          ...
          <Text h10 regular center textGray>
            {i18n.t('manualCreditPayment.component.amount1')}{' '}
          </Text>
          ...
          <Text h12 regular center white>
            {i18n.t('manualCreditPayment.component.found1')}{' '}
            <Text h12 semibold white>
              {i18n.t('manualCreditPayment.component.found2')}
            </Text>
          </Text>
          <DivSpace height-43 />
