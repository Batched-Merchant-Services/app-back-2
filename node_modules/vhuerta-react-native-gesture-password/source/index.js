...
const Top = isVertical ? (Height - Width) * 1.15 : 10;
const Radius = isVertical ? Width / 15 : Width / 25;
...
export default class GesturePassword extends Component {
  constructor(props) {
    ...
    for (let i=0; i < 9; i++) {
      ...
      circles.push({
        isActive: false,
        x       : p * (Radius * 2 + Margin) + Margin + Radius + (Width/6.2),
  ...
  onStart(e, g) {
    ...
    let y = isVertical ? e.nativeEvent.pageY - Top/1.1 : e.nativeEvent.pageY - 30;
